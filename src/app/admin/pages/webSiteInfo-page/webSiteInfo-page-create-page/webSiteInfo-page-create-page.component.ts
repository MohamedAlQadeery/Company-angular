...
@Component({
  selector: 'app-webSiteInfo-page-create-page',
  templateUrl: './webSiteInfo-page-create-page.component.html',
  styleUrls: ['./webSiteInfo-page-create-page.component.css'],
})
export class WebSiteInfoPageCreatePageComponent implements OnInit {
  constructor(
